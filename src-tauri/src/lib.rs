...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::transfers::create_remote_directory,
            commands::transfers::rename_remote_entry,
            commands::transfers::delete_remote_entry,
            commands::transfers::upload_file,
            commands::transfers::download_file,
            commands::transfers::enqueue_upload_file,
            commands::transfers::enqueue_download_file,
            commands::transfers::list_transfer_jobs,
            commands::transfers::cancel_transfer_job,
            commands::transfers::retry_transfer_job,
