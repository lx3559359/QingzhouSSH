...
foreach ($required in @('No SSH Terminal', 'Log search', 'Workflow', 'currentUser', 'portable.flag', 'Online update', 'github.com/lx3559359/QingzhouSSH', 'modelscope.cn/models/lx3559359/QingzhouSSH', 'Data root')) {
